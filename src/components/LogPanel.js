...
function LogPanel({ onActivation, logs }) {
  // function dummyLogs() {
  ...
  function handleClick() {
    setAllActivated(allActivated => !allActivated)
    onActivation(!allActivated)
  }
  ...
  return (
    <Segment className="HQComps" id="logPanel">
      ...
      <Button fluid color={allActivated ? "green" : "red"} content={allActivated ? "DEACTIVATE ALL" : "ACTIVATE ALL"} onClick={handleClick}/>
    </Segment>
  );
}
